      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Staff manage</a></li>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1 text-center">STAFF MANAGE </div>
                      <form action="#" method="POST">
                        ...
                        <div class="row pb-4">
                          <div class="input-group col-xl-6">
                            ...
                            <input type="Password" class="form-control" placeholder="****" aria-label="id" aria-describedby= "basic-addon1">
                          </div>
                          <div class="input-group col-xl-6">
                            <div class="input-group-prepend">
