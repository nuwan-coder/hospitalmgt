			...
			<div class="col-xl-12 ">
				<div class="card h-100">
					<div class="card-body my-4 mx-4">
						<div class="row my-2">
							<div class="col">
								<h3 class="font-weight-bold">Patient Transfer</h3>
							</div>
						</div>
						...
						<div class="row mt-4">
							...
							<div class="col-xl-6">
								<lable class="mt-4">To Branch / Discharge</lable>
							</div>
						</div>
						<div class="row">
							<div class="col-xl-6 mt-2">
							...
							<div class="col-xl-6 mt-2">
								<div class="form-group">
									<select class="form-control" name="toBranch">
										<option>Head</option>
						...
						<div class="row mt-4">
							<div class="col-xl-4">
								<lable class="mt-4">Channel Doctor</lable>
							</div>
							<div class="col-xl-4">
								<lable class="mt-4">Transfer / Discharge By</lable>
							</div>
							<div class="col-xl-4">
								<lable class="mt-4">Transfer / Discharge Date</lable>
							</div>
						</div>
						<div class="row">
							<div class="col-xl-4 mt-2">
								<input class="form-control" type="text" name="chanelCenterPrice" placeholder="" disabled>
							</div>
							<div class="col-xl-4 mt-2">
						...
						<div class="row mt-4 ">
							<div class="col-xl-12 mt-2 text-center">
								<button type="submit" class="btn btn-success px-4">Transfer Patient</button>
							</div>
						</div>
