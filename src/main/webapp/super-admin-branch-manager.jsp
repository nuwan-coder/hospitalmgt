      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Branch manage</a></li>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1 text-center">BRACH MANAGE </div>
                      <form action="#" method="POST">
                        <div class="row py-4">
                          ...
                          <div class="input-group col-xl-6">
                            ...
                            <input type="text" class="form-control" placeholder="Enter branch name" aria-label="id" aria-describedby= "basic-addon1">
                          </div>
                        </div>
                        <div class="row pb-4">
                          <div class="input-group col-xl-6">
                            ...
                            <input type="text" class="form-control" placeholder="Enter branch location" aria-label="id" aria-describedby= "basic-addon1">
                          </div>
                          <div class="input-group col-xl-6">
                            <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">Date</span>
                            </div>
                            <input type="Date" class="form-control" placeholder="Created date here" aria-label="id" aria-describedby= "basic-addon1" disabled>
                          </div>
                        </div>
                        <div class="row pb-4">
                          <div class="input-group col-xl-6">
